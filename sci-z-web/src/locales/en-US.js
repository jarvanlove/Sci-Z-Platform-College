export default {
  ...
  declaration: {
    ...
    clickUpload: 'Click to upload',
    uploadHint: 'Supports PDF and WORD formats, single file not exceeding 10MB',
    fileFormatError: 'Red header documents only support PDF and WORD formats, please select another file',
  ...
  report: {
    ...
    listPage: {
      ...
      keywordPlaceholder: 'Please enter report name or project name',
      ...
      noReportsHint: 'Click "Generate New Report" to create your first report',
  ...
  system: {
    ...
    apikey: {
      ...
      searchPlaceholder: 'Search key name, resource ID',
      keyName: 'Key Name',
      keyType: 'Key Type',
