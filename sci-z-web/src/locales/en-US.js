export default {
  ...
  user: {
    profile: {
      ...
      avatarCropTips: 'Drag to position and resize your avatar, then confirm to apply.',
      cropConfirm: 'Save Avatar',
      avatarPreviewTitle: 'Avatar Preview',
      previewError: 'Failed to load avatar preview. Please try again later.',
      avatarRememberSave: 'Avatar updated. Please click “Save Information” to apply.',
      avatarReused: 'Same avatar detected and reused automatically.'
    },
    security: {
      menu: 'Security',
