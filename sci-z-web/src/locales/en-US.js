export default {
  ...
  auth: {
    ...
    emailCodeLength: 'Email verification code must be 6 digits',
    ...
    smsCodeSendFailed: 'Failed to send verification code',
    smsCodeRequired: 'Please enter SMS verification code',
    smsCodeLength: 'SMS verification code must be 6 digits',
    ...
    resetPassword: {
      ...
      emailFormat: 'Please enter a valid email format',
      emailCodeLength: 'Email verification code must be 6 digits',
      phoneResetNotSupported: 'Phone reset is not supported yet, please use email reset'
    }
  },

  legal: {
    agreePrefix: 'I have read and agree to',
    smsAgreePrefix: 'Unregistered phone numbers will be automatically registered after verification and login. Registration means you agree to and accept',
    and: 'and',
    userAgreement: 'User Agreement',
    privacyPolicy: 'Privacy Policy',
  ...
  user: {
    profile: {
      ...
      smsCode: 'SMS Verification Code',
      smsCodePlaceholder: 'Please enter 6-digit verification code',
      smsCodeRequired: 'Modifying mobile number requires a verification code, please enter the verification code',
      smsCodeFormat: 'Verification code must be 6 digits',
      sendSmsCode: 'Send Verification Code',
      smsCodeSent: 'Verification code sent',
      smsCodeSendFailed: 'Failed to send verification code, please try again later',
      department: 'Department',
  ...
  declaration: {
    ...
    projectLeaderPlaceholder: 'Select or search for project leader',
    projectLeaderRequired: 'Please select project leader',
    projectLeaderLoadError: 'Failed to load project leader list',
    ...
    fieldPlaceholder: 'Please enter research field',
  ...
  project: {
    ...
    detail: {
      ...
      manager: 'Project Manager',
      managerPlaceholder: 'Select or search for project manager',
      managerLoadError: 'Failed to load project manager list',
      status: 'Project Status',
      statusPlaceholder: 'Please select status',
  ...
  knowledge: {
    ...
    deleteKbForbiddenByProject: 'This knowledge base is linked to project "{name}" and cannot be deleted.',
    kbTypeAll: 'All',
    personalKnowledgeBase: 'Personal',
    projectKnowledgeBase: 'Project',
    projectKbCannotDelete: 'Project knowledge base cannot be deleted',
    ...
    moveFileSuccess: 'File moved to {folderName}',
    moveFileFailed: 'Failed to move file, please try again later',
    ...
    permissionPublicVisible: 'Publicly Visible',
    permissionPublicVisibleDesc: 'Knowledge base visible to all users',
    permissionPrivate: 'Private',
    permissionPrivateDesc: 'Visible only to you',
    sharedByOther: 'Shared by Others',
    sharedByOwnerName: 'Shared by: {name}',
    ...
    batchMove: 'Batch Move Files',
    exitBatchMove: 'Exit Batch Move',
    ...
    uploadTip: 'Supports drag-and-drop upload, can upload multiple files in batches',
    uploadTipsTitle: 'Upload Instructions',
    uploadTipsDescription: 'Supports common file formats, single file max 200MB, max 10 files per batch',
    // File upload progress related
    uploadingFiles: 'Uploading Files',
    uploadComplete: 'Upload Complete',
    uploadFailed: 'Upload Failed',
    stageValidation: 'File Validation',
    stageMinIO: 'MinIO Uploading',
    stageMinIOComplete: 'MinIO Upload Complete',
    stageDify: 'Dify Uploading',
    stageProcessing: 'Processing',
    stageComplete: 'All Complete',
    stageUnknown: 'Unknown Status',
    uploadPartialSuccess: 'Partial files uploaded successfully (Success {success} / Total {total})',
    unsupportedFileTypesTitle: 'Unsupported File Types',
    unsupportedFileTypesDescription: 'PPT and image file types are currently not supported (e.g., .ppt, .pptx, .jpg, .png, .gif, etc.)',
    unsupportedFilesWarning: 'The following file types are not supported: {types}',
    ...
    folderNameExists: 'Folder name already exists in the same directory',
    ...
    folderHasSubfolders: 'Folder contains subfolders and cannot be deleted',
    folderHasFiles: 'Folder contains files and cannot be deleted',
    // Knowledge base list related
    getKbListFailed: 'Failed to get knowledge base list, please try again later',
    loadKbListFailed: 'Failed to load knowledge base list',
    kbExists: 'Knowledge base already exists',
    // Cover upload related
    coverUploadSuccess: 'Cover uploaded successfully',
    coverUploadNoUrl: 'Upload API did not return cover URL',
    coverUploadFailed: 'Cover upload failed',
    coverUploadFailedRetry: 'Cover upload failed, please try again later',
    uploadCover: 'Upload Cover',
    selectCoverImage: 'Select Cover Image',
    coverUploadTip: 'Recommended size 200x200px, supports JPG, PNG formats'
  },
  ...
  ai: {
    chat: {
      ...
      inputPlaceholderGuest: 'Just ask',
      ...
      rename: 'Rename',
      delete: 'Delete',
      alreadyNewChat: 'You are already on the latest chat',
      ...
      pleaseSelectKnowledgeBase: 'Please select a knowledge base',
      // Document selection dialog
      selectDocument: 'Select Document',
      knowledgeBaseLabel: 'Knowledge Base:',
      noDocumentsInKb: 'No documents in this knowledge base',
      maxKbFilesHint: 'Knowledge base files can only select up to 3',
      unnamedDocument: 'Unnamed Document',
      selectedDocumentsCount: '{count} document(s) selected',
      limitReached: '(Limit reached)',
      pleaseSelectAtLeastOneDocument: 'Please select at least one document',
      maxKbFilesWarning: 'Knowledge base files can only select up to 3. Currently {current} selected, you can only select {remaining} more',
      maxKbFilesWarningSimple: 'Knowledge base files can only select up to 3',
      documentsAdded: '{count} document(s) added',
      loadKnowledgeListFailed: 'Failed to load knowledge base list',
      loadDocumentListFailed: 'Failed to load document list',
      knowledgeBaseSelected: 'Knowledge base selected: {name}'
    },
    knowledge: {
      searchKb: 'Search Knowledge Base',
  ...
  filePreview: {
    ...
    officeLocalhostTitle: 'Cannot preview online',
    officeLocalhostNotSupported: 'File is on local server, cannot preview online. Please download the file and open it with local Office application.',
    officeViewerErrorTitle: 'Office Document Preview Service Unavailable',
    officeViewerErrorMessage: 'Office Online Viewer service may have reached usage limit. If you need to upgrade to Pro+ version for better preview experience, please contact system administrator.',
    officePreviewFailed: 'Office document preview failed, please try downloading and viewing',
