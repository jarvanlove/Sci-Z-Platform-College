export default {
  ...
  declaration: {
    ...
    clickUpload: '点击上传',
    uploadHint: '支持 PDF、图片格式，单个文件不超过 10MB',
    analyzing: 'AI 正在分析文档...',
    ...
    workflowLoadError: '加载工作流选项失败',
    workflowNoMatch: '未找到匹配的工作流',
    workflowNoData: '暂无工作流数据',
  ...
  report: {
    ...
    listPage: {
      title: '报告管理',
      keywordSearch: '关键词搜索',
      keywordPlaceholder: '请输入报告名称或项目名称',
      dateRange: '时间筛选',
      status: '状态',
      statusPending: '待生成',
      statusGenerating: '生成中',
    ...
    generatePage: {
      ...
      department: '所属部门',
      summary: '报告摘要',
      summaryPlaceholder: '请输入报告摘要（可选，最多500字）',
      typeTechDesc: '详细记录项目的技术实现、技术难点、解决方案等',
      typeSelfDesc: '项目自评报告，包含项目完成情况、成果总结等',
      typeDefaultDesc: '报告类型描述',
      generateHint: '报告生成后可在报告列表中查看和管理',
      loadProjectsError: '项目加载失败',
      noReportTypes: '暂无报告类型，请联系管理员配置',
  ...
  system: {
    ...
    role: {
      ...
      addUsers: '添加用户',
      unbindUser: '解绑用户',
      searchUserPlaceholder: '请输入用户名/真实姓名/邮箱',
