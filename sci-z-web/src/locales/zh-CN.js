export default {
  ...
  user: {
    profile: {
      ...
      smsCodeRequired: '修改手机号需要验证码，请输入验证码',
      smsCodeFormat: '验证码为6位数字',
      sendSmsCode: '发送验证码',
      smsCodeSent: '验证码已发送',
      smsCodeSendFailed: '验证码发送失败，请稍后重试',
      department: '所属部门',
  ...
  declaration: {
    ...
    projectLeader: '负责人',
    projectLeaderPlaceholder: '请选择或搜索负责人',
    projectLeaderRequired: '请选择负责人',
    projectLeaderLoadError: '加载负责人列表失败',
  ...
  project: {
    ...
    detail: {
      ...
      manager: '项目负责人',
      managerPlaceholder: '请选择或搜索负责人',
      managerLoadError: '加载负责人列表失败',
      status: '项目状态',
      statusPlaceholder: '请选择状态',
      department: '课题发布部门',
  ...
  knowledge: {
    ...
    deleteKbForbiddenByProject: '当前知识库关联项目名称({name})，不允许删除！',
    kbTypeAll: '全部',
    personalKnowledgeBase: '个人',
    projectKnowledgeBase: '项目',
    projectKbCannotDelete: '项目知识库不可删除',
    ...
    renameSuccess: '重命名成功',
    renameFailed: '重命名失败',
    moveFileSuccess: '文件已移动到 {folderName}',
    moveFileFailed: '移动文件失败，请稍后重试',
    unknownOwner: '未知创建人',
    ...
    uploadComplete: '上传完成',
    uploadFailed: '上传失败',
    stageValidation: '文件校验',
    stageMinIO: 'MinIO上传中',
    stageMinIOComplete: 'MinIO上传完成',
    stageDify: 'Dify上传中',
    stageProcessing: '处理中',
    stageComplete: '全部完成',
    stageUnknown: '未知状态',
    uploadPartialSuccess: '部分文件上传成功（成功 {success} / 总计 {total}）',
    research: '科研',
    contentCount: '个内容',
    ...
    addQuickAccess: '添加快捷访问',
    permissionSettings: '权限设置',
    permissionPublicVisible: '公开可见',
    permissionPublicVisibleDesc: '知识库所有用户可见',
    permissionPrivate: '转为私密',
    permissionPrivateDesc: '知识库仅自己可见',
    sharedByOther: '他人共享',
    sharedByOwnerName: '共享人：{name}',
    ...
    folderNameExists: '同级目录下文件夹名称已存在',
    folderRenameSuccess: '文件夹重命名成功',
    folderRenameFailed: '文件夹重命名失败',
    folderDeleteSuccess: '文件夹删除成功',
    folderDeleteFailed: '文件夹删除失败',
    folderHasSubfolders: '文件夹下存在子文件夹，无法删除',
    folderHasFiles: '文件夹下存在文件，无法删除',
    // 知识库列表相关
    getKbListFailed: '获取知识库列表失败，请稍后重试',
    loadKbListFailed: '加载知识库列表失败',
    kbExists: '已存在该知识库',
    // 封面上传相关
    coverUploadSuccess: '封面上传成功',
    coverUploadNoUrl: '上传接口未返回封面URL',
    coverUploadFailed: '上传封面失败',
    coverUploadFailedRetry: '上传封面失败，请稍后重试',
    uploadCover: '上传封面',
    selectCoverImage: '选择封面图片',
    coverUploadTip: '建议尺寸 200x200px，支持 JPG、PNG 格式'
  },
