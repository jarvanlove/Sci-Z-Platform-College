export default {
  ...
  project: {
    ...
    detail: {
      ...
      members: '项目成员',
      addMember: '添加成员',
      searchMemberPlaceholder: '搜索成员（姓名或学工号）',
      ...
      noDocuments: '暂无文档',
      uploadDocumentsHint: '上传里程碑相关文档',
      uploadText: '点击上传或拖拽文件到此处',
      uploadHint: '支持 PDF、DOC、DOCX、XLS、XLSX、PPT、TXT、MD、图片、压缩包等格式',
      uploadingFiles: '正在上传 {count} 个文件...',
      fileAlreadyExists: '文件已存在: {name}',
      documentsAddedSuccess: '已为里程碑 {milestoneIndex} 成功添加 {count} 个文档',
      documentDeletedSuccess: '已删除文档: {name}',
      noMilestones: '暂无里程碑',
