export default {
  ...
  user: {
    profile: {
      ...
      avatarCropTips: '枠をドラッグして位置とサイズを調整し、必要に応じてズームしてください。',
      cropConfirm: '新しいアバターを保存',
      avatarPreviewTitle: 'アバタープレビュー',
      previewError: 'アバターのプレビュー読み込みに失敗しました。時間を置いて再試行してください。',
      avatarRememberSave: 'アバターが更新されました。「情報を保存」をクリックして反映してください。',
      avatarReused: '同じアバターが検出されたため、そのまま利用しました。'
    },
    security: {
      menu: 'セキュリティ設定',
      title: 'セキュリティ設定',
      ...
      passwordStrengthHint: '英字と数字を含め、大小文字・記号の併用を推奨します',
