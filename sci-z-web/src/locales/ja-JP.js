export default {
  ...
  report: {
    ...
    generatePage: {
      ...
      department: '所属部門',
      summary: 'レポート要約',
      summaryPlaceholder: 'レポート要約を入力してください（オプション、最大500文字）',
      typeTechDesc: '技術実装、技術的難点、解決策などの詳細記録',
      typeSelfDesc: 'プロジェクト自己評価レポート、プロジェクト完了状況、成果まとめなど',
      typeDefaultDesc: 'レポートタイプの説明',
      generateHint: '生成後、レポートリストでレポートを表示および管理できます',
      loadProjectsError: 'プロジェクトの読み込みに失敗しました',
      noReportTypes: 'レポートタイプがありません。管理者に連絡して設定してください',
