export default {
  ...
  user: {
    profile: {
      ...
      invalidFormat: 'jpg/png/gif/svg 이미지 파일만 지원합니다',
      fileTooLarge: '이미지 크기는 5MB를 초과할 수 없습니다',
      avatarCropTitle: '아바타 조정',
      avatarCropTips: '선택 영역을 드래그하여 위치와 크기를 조정하고, 필요하면 확대/축소하세요.',
      cropConfirm: '새 아바타 저장',
      avatarPreviewTitle: '아바타 미리보기',
      previewError: '아바타 미리보기를 불러오지 못했습니다. 잠시 후 다시 시도해주세요.',
      avatarRememberSave: '아바타가 업데이트되었습니다. “정보 저장”을 눌러 적용하세요.',
      avatarReused: '동일한 아바타가 감지되어 기존 파일을 재사용했습니다.'
    },
    security: {
      menu: '보안 설정',
      title: '보안 설정',
      ...
      passwordStrengthHint: '영문과 숫자를 포함하고 대소문자 및 특수문자 사용을 권장합니다',
