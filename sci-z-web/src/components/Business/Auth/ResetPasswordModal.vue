...
<template>
  <Teleport to="body">
    <Transition name="fade">
      <div v-if="visible" class="reset-password-modal-overlay">
        <div class="reset-password-modal-wrapper">
          <!-- 关闭按钮 -->
          <button class="reset-password-modal-close" @click="handleClose">
...
const { closeResetPasswordModal, openLoginModal } = useAuthModal()
...
const handleClose = () => {
  ...
  // 如果当前路由是 /reset-password，返回到之前的页面
