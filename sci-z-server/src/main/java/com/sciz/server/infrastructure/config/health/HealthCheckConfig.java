                        ...
                        try (Connection connection = dataSource.getConnection()) {
                                if (connection.isValid(5)) {
                                        ...
                                        log.info(String.format(
                                                        ...
                                                        databaseProductName, databaseProductVersion, driverName,
                                                        driverVersion, url, responseTime));
                                        return Health.up()
                                ...
                                log.error(String.format(
                                                ...
                                                e.getMessage(), e.getErrorCode(), e.getSQLState(), responseTime,
                ...
                return () -> {
                        ...
                        try {
                                ...
                                log.error(String.format(
                                                ...
                                                kafkaBootstrapServers, e.getMessage(), e.getClass().getSimpleName(),
                                                responseTime,
                ...
                return () -> {
                        ...
                        try {
                                ...
                                log.error(String.format(
                                                ...
                                                minioEndpoint, e.getMessage(), e.getClass().getSimpleName(),
                                                responseTime,
                                                e.getCause() != null ? e.getCause().getClass().getSimpleName()
                                                                : "null"),
                                                e);
        ...
        public HealthIndicator mailHealthIndicator(
                ...
                return () -> {
                        ...
                        try {
                                ...
                                // 检查已启用的邮箱服务商
                                Map<MailProviderStatus, MailProviderProperties.ProviderConfig> providers = mailProviderProperties
                                                .providers();
                                ...
                                if (firstEnabled.isPresent()) {
                                        ...
                                        if (!configValid) {
                                                ...
                                                log.warn(String.format(
                                                                ...
                                                                providerType.name(), config.smtpEnabled(),
                                                                config.oauthEnabled(), responseTime));
                                                return Health.down()
                                                                .withDetail("mail",
                                                                                "Mail provider configuration invalid")
                                        ...
                                        log.info(String.format(
                                                        ...
                                                        enabledProviders, providerType.name(), configType,
                                                        enabledProviders.size(), responseTime));
                                        return Health.up()
