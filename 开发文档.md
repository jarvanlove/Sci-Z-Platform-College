...
└── src/main/
    ...
    └── resources/
        ...
        │   │   ├── V2__init_industry_config_tables.sql
        │   │   ├── V3__init_ai_assistant_tables.sql
        │   │   ├── V4__init_declaration_tables.sql
        │   │   ├── V5__init_project_tables.sql
        │   │   ├── V6__init_attachment_tables.sql
        │   │   ├── V7__init_knowledge_tables.sql
        │   │   ├── V8__init_report_tables.sql
        │   │   └── V9__init_system_config_tables.sql
        │   └── seed/                                 # 初始数据
        │       └── init_data.sql
